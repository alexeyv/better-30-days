...
- Weight novelty over count. Five engineers in the core area = scaling ("doubling down"). Two roles in a domain the company has never touched = a new bet — usually the more important signal. The `Strategic single-role signals` list (founding / first-of-function / new-geo roles) is not count-gated; judge its novelty yourself.
